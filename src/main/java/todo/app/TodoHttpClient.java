...
public interface TodoHttpClient {
    ...
    static TodoHttpClient create(String url) {
        var retrofit = new Retrofit.Builder()
                .baseUrl(url)
                .addConverterFactory(JacksonConverterFactory.create())
                .build();

        return retrofit.create(TodoHttpClient.class);
    }

    static TodoHttpClient create() {
        return create("https://jsonplaceholder.typicode.com/");
    }
}
